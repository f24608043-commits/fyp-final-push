    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-md rounded-2xl bg-surface-container-lowest p-8 shadow-md">
        ...
        <div className="mb-6 text-center">
          <h1 className="font-headline-lg text-on-surface tracking-tight font-extrabold">Welcome Back</h1>
          <p className="mt-1 font-body-md text-on-surface-variant">Sign in to continue your learning journey</p>
        </div>
        ...
        <form action={signIn} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-primary-container text-on-primary py-3 font-label-lg font-bold uppercase tracking-wider shadow-lg hover:bg-primary transition-all active:translate-y-[2px]"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="mt-6 text-center font-body-sm text-on-surface-variant">
          ...
          <Link href="/sign-up" className="font-label-md font-bold text-primary hover:underline">
            Sign Up
          </Link>
        </div>
      </div>
